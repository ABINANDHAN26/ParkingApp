...
public class ParkingReceiptActivity extends AppCompatActivity {
    private TextView txtViewEmail, txtViewCarPlate, txtViewCompany, txtViewColor, txtViewHours,txtViewPriceHr, txtViewDateTime, txtViewLot, txtViewSpot, txtViewPayment, txtViewAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtViewPriceHr = findViewById(R.id.textPriceHour);
        ...
        myRef.orderByKey().limitToLast(1).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    txtViewPriceHr.setText(receipt.getPriceHour());
